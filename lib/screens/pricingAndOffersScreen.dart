...
class PricingAndOffers extends BaseRoute {
  PricingAndOffers({a, o}) : super(a: a, o: o, r: 'PricingAndOffers');

  @override
  _PricingAndOffersState createState() => new _PricingAndOffersState();
}

class _PricingAndOffersState extends BaseRouteState {
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            Card(
                                              child: _nearByCouponsList![index].vendor_logo != null
                                                  ? CachedNetworkImage(
                                                      imageUrl: global.baseUrlForImage + _nearByCouponsList![index].vendor_logo!,
                                            ...
                                            Expanded(
                                              child: Padding(
                                                padding: global.isRTL ? EdgeInsets.only(right: 18.0) : EdgeInsets.only(left: 18),
                                                child: Column(
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                            ...
                                            Padding(
                                              padding: global.isRTL ? EdgeInsets.only(left: 8.0) : EdgeInsets.only(right: 8.0),
                                              child: SizedBox(
                                                height: 40,
                                                child: FDottedLine(
                                    ...
                                    global.isRTL
                                        ? Positioned(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(color: Theme.of(context).primaryColorLight.withOpacity(0.2), borderRadius: BorderRadius.only(topLeft: Radius.circular(10), bottomRight: Radius.circular(10))),
                                              child: Text(
                                                '${_nearByCouponsList![index].vendor_name}',
                                                textAlign: TextAlign.right,
                                                style: TextStyle(fontSize: 11, color: Color(0xFF898A8D), fontWeight: FontWeight.w400),
                                              ),
                                            ),
                                          )
                                        : Positioned(
                                            ...
                                            child: Container(
                                              padding: EdgeInsets.fromLTRB(8, 2, 8, 2),
                                              decoration: BoxDecoration(color: Theme.of(context).primaryColorLight.withOpacity(0.2), borderRadius: BorderRadius.only(topRight: Radius.circular(10), bottomLeft: Radius.circular(10))),
                                              child: Text(
                                                '${_nearByCouponsList![index].vendor_name}',
                                                textAlign: TextAlign.right,
                                                style: TextStyle(fontSize: 11, color: Color(0xFF898A8D), fontWeight: FontWeight.w400),
  ...
  _init() async {
    try {
      ...
      print("Exception - pricingAndOffersScreen.dart - _init():" + e.toString());
    }
  }
  ...
  _getNearByCouponsList() async {
    try {
      ...
      print("Exception - pricingAndOffersScreen.dart - _getNearByCouponsList():" + e.toString());
    }
  }
