...
class BarberShopDescriptionScreen extends BaseRoute {
  ...
  BarberShopDescriptionScreen(this.vendorId, {a, o})
      : super(a: a, o: o, r: 'BarberShopDescriptionScreen');

  @override
  _BarberShopDescriptionScreenState createState() =>
      new _BarberShopDescriptionScreenState(this.vendorId);
}
...
class _BarberShopDescriptionScreenState extends BaseRouteState {
  ...
  _getBarberShopDescription() async {
    try {
      ...
      if (isConnected) {
        await apiHelper!
            .getBarberShopDescription(
                vendor_id: vendorId, global.lat, global.lng)
            .then((result) {
          if (result != null) {
            if (result.status == "1") {
