...
class ServiceDetailScreen extends BaseRoute {
  ...
  ServiceDetailScreen({a, o, this.serviceName, this.serviceImage}) : super(a: a, o: o, r: 'ServiceDetailScreen');
  @override
  _ServiceDetailScreenState createState() => new _ServiceDetailScreenState(serviceName: serviceName, serviceImage: serviceImage);
}
...
class _ServiceDetailScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
                      ...
                      Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Padding(
                                padding: global.isRTL ? EdgeInsets.only(right: 8, top: 20) : EdgeInsets.only(left: 8, top: 20),
                ...
                child: Padding(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return Card(
                            shape: selectedVendorId != null && selectedVendorId == _barberShopList![index].vendor_id ? RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: Theme.of(context).primaryColor, width: 2)) : null,
                            child: Column(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      GestureDetector(
                                        onTap: () {
                                          if (selectedVendorId == _barberShopList![index].vendor_id) {
                                            selectedVendorId = null;
                                          } else {
                                            selectedVendorId = _barberShopList![index].vendor_id;
                                          }
                                        ...
                                        child: CachedNetworkImage(
                                          ...
                                          imageBuilder: (context, imageProvider) => Container(
                                            ...
                                            child: selectedVendorId != null && selectedVendorId == _barberShopList![index].vendor_id
                                                ? Container(
                                                    decoration: BoxDecoration(
          ...
          bottomNavigationBar: _barberShopList!.length > 0 && selectedVendorId != null
              ? SafeArea(
                child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                            ...
                            child: Text(AppLocalizations.of(context)!.lbl_book_now)),
                      ],
                    ),
                  ),
              )
  ...
  _getSalonListForServices() async {
    try {
      ...
      if (isConnected) {
        await apiHelper!.getSalonListForServices(global.lat, global.lng, serviceName).then((result) {
          if (result != null) {
            if (result.status == "1") {
      ...
      print("Exception - serviceDetailScreen.dart - _getSalonListForServices():" + e.toString());
    }
  }
