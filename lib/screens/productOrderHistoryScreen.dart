...
class ProductOrderHistoryScreen extends BaseRoute {
  ProductOrderHistoryScreen({a, o}) : super(a: a, o: o, r: 'ProductOrderHistoryScreen');

  @override
  _ProductOrderHistoryScreenState createState() => new _ProductOrderHistoryScreenState();
}

class _ProductOrderHistoryScreenState extends BaseRouteState {
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return GestureDetector(
                          ...
                          child: Card(
                              ...
                              child: ListTile(
                                title: Text('${_productOrderHistoryList![index].cart_id}', style: Theme.of(context).primaryTextTheme.titleSmall),
                                subtitle: Padding(
