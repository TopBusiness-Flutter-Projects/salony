...
class _NotificationScreenState extends BaseRouteState {
  ...
  _delConfirmationDialog() async {
    try {
      ...
      print('Exception - notificationScreen.dart - _delConfirmationDialog(): ' + e.toString());
    }
  }
  ...
  Future<bool> _deleteAllNotifications() async {
    ...
    try {
      ...
      print("Exception - notificationScreen.dart - _deleteAllNotifications():" + e.toString());
      return _isdeletedSuccessfully;
    }
  }
  ...
  _getNotifications() async {
    try {
      ...
      print("Exception - notificationScreen.dart - _getNotifications():" + e.toString());
    }
  }
