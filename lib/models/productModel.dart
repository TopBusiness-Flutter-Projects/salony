class Product {
  ...
  Product.fromJson(Map<String, dynamic> json) {
    try {
      ...
      subcat_id =
          json['subcat_id'] != null ? int.parse('${json['subcat_id']}') : null;
      ...
      isFavourite = json['isFavourite'] != null && json['isFavourite'] == true
          ? true
          : false;
      wish_id =
          json['wish_id'] != null ? int.parse('${json['wish_id']}') : null;
      cart_qty =
          json['cart_qty'] != null ? int.parse('${json['cart_qty']}') : null;
    } catch (e) {
      print(
