...
class CurrentUser {
  ...
  CurrentUser.fromJson(Map<String, dynamic> json) {
    try {
      ...
      image = json['image'] != null && json['image'].toString() != 'N/A'
          ? json['image']
          : '';
      ...
      phone_verified = json['phone_verified'] != null &&
              int.parse('${json['phone_verified']}') == 1
          ? true
          : false;
      referral_code =
      ...
      cart_count = json['cart_count'] != null
          ? int.parse('${json['cart_count']}')
          : null;
  ...
  Map<String, dynamic> toJson() => {
        ...
        'user_name':
            user_name != null && user_name!.isNotEmpty ? user_name : null,
        ...
        'user_email':
            user_email != null && user_email!.isNotEmpty ? user_email : null,
