...
class AllBookings {
  ...
  AllBookings.fromJson(Map<String, dynamic> json) {
    try {
      ...
      in_door_val = json['in_door_val'] != null ? json["in_door_val"] : null;
      ...
      cart_services =
          json['cart_services'] != null && json['cart_services'] != []
              ? List<ServiceCart>.from(
                  json['cart_services'].map((x) => ServiceCart.fromJson(x)))
              : [];
      vendor_review = json['vendor_review'] != null
          ? ReviewRating.fromJson(json['vendor_review'])
          : null;
      staff_review = json['staff_review'] != null
          ? ReviewRating.fromJson(json['staff_review'])
          : null;
    } catch (e) {
      print("Exception - allBookingsModel.dart - AllBookings.fromJson():" +
          e.toString());
    }
  }
}
  ...
  ReviewRating.fromJson(Map<String, dynamic> json) {
    try {
      rating = json['rating'] != null
          ...
          : null;
      review_description = json['review_description'] != null
          ? json['review_description']
          : null;
      description = json['description'] != null ? json['description'] : null;
    } catch (e) {
      print("Exception - allBookingsModel.dart - ReviewRating.fromJson():" +
          e.toString());
    }
  }
}
